...
class MonteCarloTreeSearch {
  findNextMove(board, playerNo) {
    ...
    if (winnerNode.state.winScore === 0) debugger
    console.log('player: ', playerNo, winnerNode.state.winScore, winnerNode.state.board.boardValues)
  ...
  simulateRandomPlayout(node, opponent) {
    ...
    if (boardStatus === opponent) {
      console.log('loss against opponent detected: ', opponent)
